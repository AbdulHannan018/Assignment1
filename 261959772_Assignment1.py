...
def admin_menu():
    while True:
        ...
        if choice == '1':
            ...
            print("You selected option 1: Add a flight")
            manage_flight_details()
            # Add your code to add a flight here
        elif choice == '2':
            # Handle modifying a flight
            print("You selected option 2: Modify a flight")
            modify_flight_details()
            # Add your code to modify a flight here
        elif choice == '3':
            # Handle removing a flight
            print("You selected option 3: Remove a flight")
            # Add your code to remove a flight here
        elif choice == '4':
            # Exit the menu
